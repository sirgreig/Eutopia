...
import { Island, Position } from '../../types';
...
export const AIIslandMinimap: React.FC<AIIslandMinimapProps> = ({
  ...
  const renderIsland = (tileSize: number, showDetails: boolean) => {
    ...
    return (
      <Svg width={width} height={height} viewBox={`0 0 ${width} ${height}`}>
        ...
        {island.tiles.map((tile) => {
          ...
          const buildingColor = tile.building ? BUILDING_COLORS[tile.building] || '#666' : '#8fbc8f';
          ...
          return (
            <G key={tile.id}>
              ...
              <Rect
                ...
                width={tileSize}
                height={tileSize}
                fill={tile.building ? buildingColor : '#c2b280'}
                stroke="#1a5276"
                strokeWidth={0.5}
              />
              {/* Rebel indicator */}
    ...
    <>
      ...
      >
        ...
        <View style={styles.minimapContainer}>
          {renderIsland(MINI_TILE_SIZE, false)}
        </View>
        ...
        <Pressable style={styles.modalOverlay} onPress={() => setExpanded(false)}>
          <View style={styles.expandedContainer}>
            ...
            <View style={styles.expandedMapContainer}>
              {renderIsland(EXPANDED_TILE_SIZE, true)}
            </View>
            ...
            <View style={styles.legendContainer}>
              ...
              <View style={styles.legendGrid}>
                <View style={styles.legendItem}>
                  <View style={[styles.legendColor, { backgroundColor: '#8B4513' }]} />
                ...
                <View style={styles.legendItem}>
                  <View style={[styles.legendColor, { backgroundColor: '#8B8B00' }]} />
              ...
              <View style={styles.legendGrid}>
                <View style={styles.legendItem}>
                  ...
                  <Text style={styles.legendText}>Fishing Boat</Text>
                </View>
                <View style={styles.legendItem}>
